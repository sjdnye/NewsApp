package com.example.newsappmvvm.ui.uI
...
import com.example.newsappmvvm.ui.NewsApplication
...
//
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String){
        ...
        try {
            if (hasInternetConnection()){
                val response =  newsRepository.getSearchForNews(searchQuery, searchNewsPage)
